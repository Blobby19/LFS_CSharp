...
{
    public partial class vJoyForm : Form
    {
        static public vJoy joystick;
        static public vJoy.JoystickState iReport;
        static public Thread vjoythread;

        static void Main2(object state)
        {
            vjoythread = new Thread(new ThreadStart(ThreadJoy));
            vjoythread.Start();
            Application.Run((Form)state);
        }

        static public void ThreadJoy()
        {
            ...
            LP lp = new LFS_CSharp.LP(10, 0.2, 0);
        ...
        public static vJoyForm Create()
        {
            vJoyForm form = new vJoyForm();
        ...
        private void vJoyForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (vjoythread != null && vjoythread.IsAlive)
                vjoythread.Abort();
        }
    }
}